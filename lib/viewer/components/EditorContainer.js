...
const EditorContainer = props => {
  const { version, screenSize, editable, switcherEnabled, dashboardsMenu} = props;
  return (
    <div
      className={
        version === "editor"
    ...
    >
      ...
      <EditorDashboardTopBar version={version} editable={editable} />
      <div
      ...
      >
        <EditorTopToolbar version={version} switcherEnabled={switcherEnabled} />
