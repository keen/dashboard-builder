          ...
          if (index !== second && index > second) {
            ...
            if (col.collision) {
              ...
              const posX =
                ...
                if(!this.movePosXY || (this.movePosXY.posX !== posX && this.movePosXY.posY !== posY)){
                  this.movePosXY = {
                    posX,
                    posY
                  }
                ...
                (this.movePosXY.posX === posX && this.movePosXY.posY === posY) && this.moveCount;
                if(this.moveCount > 20){posY += 100}
        ...
        {dashboardInfo.id !== "" &&
          ...
          this.parsedItems.map((el, index) => {
            ...
            if (
              ...
              const containerClass = type === 'heatmap' ? 'heatmap-container' : '';
              return (
                <div
                  style={{
                    width,
