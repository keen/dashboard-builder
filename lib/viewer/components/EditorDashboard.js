...
class EditorDashboard extends Component {
  ...
  componentDidUpdate() {
    ...
    if (this.props.template
      && this.props.template.font
      && this.props.template.font.family) {
      WebFont.load({
        google: {
          families: [this.props.template.font.family]
        }
      });
    }
  }
  ...
  render() {
    ...
    const boldStyle = (font && font.bold) ? 'font-weight: bold;' : '';
    const italicStyle = (font && font.italic) ? 'font-style: italic;' : '';
    const textAlign = (font && font.textAlign) ? font.textAlign : 'left';
    const family = (font && font.family) ? font.family : 'inherit';
    let max = 0;
    let maxHeight = 0;
    ...
    return (
      ...
      >
        ...
        <style jsx global>{`
          ...
          .dashboard-builder .chart-container .chart-title input {
            text-align: ${textAlign};
          }
