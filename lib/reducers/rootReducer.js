...
const editorReducer = (state = defaultData, action) => {
  ...
  switch (action.type) {
    ...
    case actionTypes.CHANGE_CHART_TYPE:
      console.log('CHANGE_CHART_TYPE', action.value);
      return {
        ...state,
        dashboardInfo: {
          ...dashboardInfo,
    ...
    case actionTypes.SELECT_POINTS_SIZE:
      ...
      case actionTypes.SHOW_HEATMAP_SLIDERS:
        console.log('SHOW_HEATMAP_SLIDERS', action.value);
      return {
        ...state,
        dashboardInfo: {
          ...dashboardInfo,
      ...
      case actionTypes.SHOW_HEATMAP_TOOLTIP_VALUE:
        console.log('SHOW_HEATMAP_TOOLTIP_VALUE', action.value);
      return {
        ...state,
        dashboardInfo: {
          ...dashboardInfo,
            ...
            items: [
              ...dashboardInfo.data.items.map((el, i) =>
                action.index === i
                  ? {
                      ...el,
                      showHeatmapTooltipValue: action.value
                    }
                  : el
              )
            ]
