...
export const addSavedQueryToList = value => ({
  type: actions.ADD_SAVE_QUERY_TO_LIST,
  value
});

export const deleteSavedQueryFromList = value => ({
  type: actions.DELETE_SAVE_QUERY_FROM_LIST,
  value
});
