      ...
      {settingsVisible !== false && (
        <React.Fragment>
          ...
          {/* Image settings */}
          {
            ...
            <React.Fragment>
              <h4>Image url:</h4>
              <input onChange={e => setSrcForImg(e, settingsVisible)} className="settings-input" value={dashboardData.src} />
            </React.Fragment>
          }
          {/* Paragraph settings */}
          {
            ...
            <React.Fragment>
              <h4>Text:</h4>
              <TextEditor setTextForParagraph={setTextForParagraph} value={dashboardData.text} index={settingsVisible}/>
            </React.Fragment>
          }
        </React.Fragment>
      )}
