    ...
    <div className="toolbar" onMouseLeave={toolbarVisibleHide}>
      ...
      >
        <div className="toolbar-hidden">
          ...
          <h4>Table charts</h4>
          <p draggable onDragStart={dragStartHandler} name="table">
            <FontAwesomeIcon icon="table" />
          </p>
          <h4>Custom</h4>
          <p draggable onDragStart={dragStartHandler} name="paragraph">
            <FontAwesomeIcon icon="paragraph" />
          </p>
          <p draggable onDragStart={dragStartHandler} name="image">
