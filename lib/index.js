  ...
  constructor(props) {
    ...
    ReactDOM.render(
      <Provider store={store}>
        <Router>
          <Route path="/" component={routeProps => <MainBuilder {...routeProps} {...props} />} exact/>
          <Route path="/editor/:id" component={routeProps => <Editor {...routeProps} {...props} />} />
          <Route path="/viewer/" component={routeProps => <MainViewer {...routeProps} {...props} />} exact />
          <Route path="/viewer/:id" component={routeProps => <Viewer {...routeProps} {...props} />} />
        </Router>
      </Provider>,
