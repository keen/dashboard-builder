...
class Chart extends PureComponent {
  ...
  //     this.props.point.show != nextProps.point.show ||
  //     this.props.point.r != nextProps.point.r ||
  //     this.props.choropleth.map != nextProps.choropleth.map ||
  //     this.props.choropleth.borders.show != nextProps.choropleth.borders.show ||
  //     this.props.choropleth.borders.size != nextProps.choropleth.borders.size ||
  //     this.props.choropleth.showSlider != nextProps.choropleth.showSlider ||
  //     this.props.heatmap.showSlider !== nextProps.heatmap.showSlider ||
  //     this.props.heatmap.simpleTooltip !== nextProps.heatmap.simpleTooltip
  //   ) {
  //     return true;
  //   }
  //   return false;
  ...
  createKeenDataviz() {
    const chartProps = {
      ...
      results:
        ...
        _.isEqual(this.props.results.result, [200, 300, 100, 400, 250])
          ? { result: [430, 300, 220, 150, 80] }
          : this.props.results
    };
    console.log('>>> Chart.js ', chartProps);
