...
class ChartContainer extends Component {
  ...
  componentDidUpdate() {
    console.log('chart container did update');
  }
  ...
  render() {
    ...
    // console.log('===== chart container REDNER!!!', template['title.text']);
    if (
    ...
    const heatmapSettings = {
      ...
      simpleTooltip: heatmapTooltipValue
        ? heatmapTooltipValue.value
        : false
    };

    // const title = (template && template['title.show']) ? template['title.text'] : false;
    // const subtitle = (template && template['subtitle.show']) ? template['subtitle.text']: false;
    // const legendAlignment = (template['legend.layout'] === 'top' || template['legend.layout'] === 'bottom')
    // ? template['legend.position.horizontal'] : template['legend.position.vertical'];
    // const legendOptions = { show: template['legend.show'], position: template['legend.layout'], alignment: legendAlignment };
    // const data = template['series.label.show'] ? { labels: true } : false;
    // const point = { show: template['series.points.show'], r: template['series.points.size'] };
    ...
    return (
      <React.Fragment>
        ...
        <Chart
          ...
          // }
          // sparkline={sparkline && sparkline.value}
          // stacking={stacking && stacking.value}
          // point={pointSettings}
          // choropleth={choroplethSettings}
...
const mapStateToProps = state => {
  const {
    ...
    dashboardInfo: {
      id,
      settings: { dryRun, theme:template = {} },
      // theme:template = {},
    }
  } = state;
  return {
