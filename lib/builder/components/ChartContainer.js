...
class ChartContainer extends Component {
  ...
  render() {
    ...
    const heatmapSettings = {
      ...
      tooltip: {
        showValueOnly: showHeatmapTooltipValue ? showHeatmapTooltipValue.value : false,
      }
    }

    console.log('heatmapSettings ', heatmapSettings, slidersHeatmap, showHeatmapTooltipValue);
